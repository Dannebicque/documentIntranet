...
Cette fonctionnalité permet de connaître les informations des étudiants que vous suivez sur des formations en stage. Vous pourrez également depuis cette interface compléter des fiches de suivi qui seront accessible par le responsable de la formation et l'assistant(e) du département.
...
Dans cet onglet, vous avez les informations des stagiaires que vous suivez, mais aussi des alternants ("Stages à suivre")
...
![Onglet des stages que vous devez suivre](/images/permanent/suivi01.png)
...
## Effectuer un suivi d'un stagiaire.
